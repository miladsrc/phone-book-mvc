...
public class JwtService {
    ...
    public String buildToken(
        ...
        if (extraClaims == null || userDetails == null) {
            throw new IllegalArgumentException("extraClaims and userDetails cannot be null");
        }
        if (expiration <= 0) {
    ...
    //fix and set get sign in key to secret key get
